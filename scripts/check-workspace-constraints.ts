...
const appPackageFiles: Readonly<Record<string, readonly string[]>> = {
  ...
  // The extension host loads dist/extension.cjs; runtime/cordis.yml and media/
  // ride along as launch-time assets. Sourcemaps stay unpublished, as everywhere.
  '@deepseek-ai/dsh-vscode': ['dist', '!dist/**/*.map', 'runtime', 'media'],
}
